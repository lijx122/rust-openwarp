...
keybinding-desc-workspace-left-panel-remote-files = 左パネル: リモートファイル
...
workspace-left-panel-remote-files = リモートファイル
