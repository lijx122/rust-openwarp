...
keybinding-desc-workspace-left-panel-remote-files = Left Panel: Remote files
...
menu-filetree-download = Download
...
workspace-left-panel-remote-files = Remote files
